...
?>
    ...
    <section class="relative h-screen flex items-center">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
            ...
            <a class="inline-flex items-center px-8 py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition group" href="/products">
                Explore Collection
    ...
    <section class="py-20 bg-indigo-600 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <form class="max-w-md mx-auto flex gap-4"><input type="email" placeholder="Enter your email" class="flex-grow px-4 py-2 rounded-md text-gray-900 focus:outline-none focus:ring-2 focus:ring-white"><button class="px-6 py-2 bg-white text-indigo-600 rounded-md hover:bg-gray-100 transition">Subscribe</button></form>
        </div>
    </section>
