                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden md:flex items-center space-x-8">
                            <a class="text-gray-700 hover:text-indigo-600 transition" href="/">Home</a>
                            <a class="text-gray-700 hover:text-indigo-600 transition" href="/about.php">About</a>
                            <a class="text-gray-700 hover:text-indigo-600 transition" href="/products.php">Collection</a>
                            <a class="text-gray-700 hover:text-indigo-600 transition" href="/contact.php">Contact</a>
                        </div>
