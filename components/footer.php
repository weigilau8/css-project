            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <li><a href="/products" class="text-gray-400 hover:text-white transition">Collection</a></li>
                    ...
                    <div>
                        ...
                        <li class="flex items-center space-x-2">
                            ...
                            <span class="text-gray-400">info@chrono.com</span>
                        </li>
                        <li class="flex items-center space-x-2">
                            ...
                            <span class="text-gray-400">123 Luxury Lane, NY 10001</span>
                        </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <form class="space-y-2"><input type="email" placeholder="Enter your email" class="w-full px-4 py-2 rounded bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"><button class="w-full px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 transition">Subscribe</button></form>
                    </div>
                </div>
